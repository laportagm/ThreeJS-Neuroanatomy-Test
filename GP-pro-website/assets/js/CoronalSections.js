...
async function init() {
  ...
  container = document.getElementById('coronal-threejs-container');

  if (!container) {
    console.error('Container element with id "coronal-threejs-container" not found.');
    return;
  }
  ...
  const modelPaths = [
    'assets/models/coronal-section-1.glb',
    'assets/models/coronal-section-2.glb',
    'assets/models/coronal-section-3.glb',
    'assets/models/coronal-section-4.glb',
    'assets/models/coronal-section-5.glb',
    'assets/models/coronal-section-6.glb',
    'assets/models/coronal-section-7.glb',
    'assets/models/coronal-section-8.glb',
    'assets/models/coronal-section-9.glb',
    'assets/models/coronal-section-10.glb',
    'assets/models/coronal-section-11.glb',
  ];
